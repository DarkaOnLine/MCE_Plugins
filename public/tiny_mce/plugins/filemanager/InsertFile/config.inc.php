...
$MY_DOCUMENT_ROOT     = dirname(__FILE__).'/../../../../../uploads/docs'; /* system path to the directory you want to manage the files and folders

/* MY_BASE_URL  Not used in htmlarea3-plugin version  */
//$MY_BASE_URL          = $cfg["site"]["host"];
$MY_BASE_URL          = "/uploads/docs";
...
*/
$MY_URL_TO_OPEN_FILE  = $cfg["site"]["host"]."/uploads/docs";
